...
{
    class ProductsFunction : INotifyPropertyChanged
    {
        ...
        public async Task trnProducts(string action)
        {
            try
            {
                if (product == null || String.IsNullOrWhiteSpace(product.productLongitude) || product.productLatitude == null)
                {
                ...
                if (connectFirebase())
                {
                    ...
                    products.productLongitude = product.productLongitude;
                    products.productLatitude = product.productLatitude;
            ...
            try
            {
                ...
                if (connectFirebase())
                {
                    ...
                    new Products
                    {
                        ...
                        productLongitude = x.Object.productLongitude,
                        productLatitude = x.Object.productLatitude,
                    }).ToList();
        ...
        public void setProduct(Products edt)
        {
            ...
            product.productLongitude = edt.productLongitude;
            product.productLatitude = edt.productLatitude;
            btnSaveText = "UPDATE";
